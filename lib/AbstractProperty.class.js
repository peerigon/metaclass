...
function AbstractProperty(Comment, Visibility) {
     ...
     *
     * You may also pass a function to indicate that this property must be an instance of it.
     *
    ...
    Public.setType = Properties.setType = function (type) {
        ...
        if (typeIs.existent() && typeIs.notInstanceOf(String) && typeIs.notInstanceOf(Function)) {
            throw new TypeError("The property's type must be undefined, null, an instance of String or an instance of Function");
        }
        this.__type = type;
        return Public;
    }.bind(Properties);
