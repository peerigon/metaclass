...
module.exports = function Class() {
    ...
    Public.setClassId = this.setClassId = function (classId) {
        ...
        if (typeof classId !== "string" &&
                ...
                classId !== null) {
            throw new TypeError("The class id must be a string");
        }
        if (classId !== null) {
            ...
            classNameFirstChar = className.charAt(0);
            if (classNameFirstChar !== classNameFirstChar.toUpperCase()) {
                throw new Error(
                    "The class name '" + className + "' in class id '" + classId +
    ...
    Public.setProperty = this.setProperty = function (property) {
        ...
        this.__cachedProps = null; // deleting cache
        return Public;
    }.bind(this);
    ...
    Public.setSuperClass = this.setSuperClass = function (superClass) {
        if (superClass !== null && is(superClass).instanceOf(Class) === false) {
            throw new TypeError("The superClass must be an instance of Class");
        }
