...
function Class(propCollection, PropertyCollection, PropertyFilter) {
    ...
    /**
     * Returns all properties from the super classes in a single array
     *
     * @public
    ...
    Public.getInheritedProperties = Properties.getInheritedProperties = function () {
        ...
        function collectProperties(currentClass) {
            ...
            if (superClass === null) {
                ...
                // This way, result contains only properties, that are NOT overridden.
                superProps = collectProperties(superClass);
            }
        ...
        if (superClass) {
            result = collectProperties(superClass);
            result.forEach(function(prop) {
                        console.log(prop.getName());
                    });
            result = propertyFilter.applyOn(result); // removes all private properties
        }
    ...
    Public.getOverriddenProperties = Properties.getOverriddenProperties = function () {
        ...
        function collectSuperProperties(currentClass) {
            ...
            if (superClass === null) {
                ...
                // After that we add the property to superProps.
                // This way, result contains only properties, that are NOT overridden.
                superProps = collectSuperProperties(superClass);
            }
        ...
        result = propertyFilter.applyOn(props);  // removes all private properties, because they can't be overridden
