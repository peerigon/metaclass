...
function Comment() {
    var Properties = {
            Super: new String()     //  ignore jslint warning here, it's the right way to do
        },
        Public = this;
    ...
    Properties.setDescription = Public.setDescription = function (descr) {
        ...
        if (descr !== null && is(descr).notInstanceOf(String)) {
    ...
    Properties.setTag = Public.setTag = function (name, value) {
        ...
        if (is(value).notInstanceOf(String) && value !== null) {
