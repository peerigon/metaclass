 ...
 *
 * @constructor
 * @param {!Function} AbstractMethod
 * @param {!Function} AbstractProperty
 */
function PropertyCollection(AbstractMethod, AbstractProperty) {
    var Properties = {},
        Public = this;

    AbstractMethod = AbstractMethod || require("./AbstractMethod.class.js");
    AbstractProperty = AbstractProperty || require("./AbstractProperty.class.js");
