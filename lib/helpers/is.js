...
function is(subject) {
    ...
    return {
         ...
         *
         * If the subject exposes an Extends-property, this will be checked first.
         *
         * @param {!Object} Class
         * @throws {TypeError}
         * @return {Boolean}
        ...
        instanceOf: function instanceOf(Class) {
            ...
            checkExtendsProperty(SubjectConstructor, Class);
            if (nativeTypeConstructorMap[subjectType] === undefined) {
                return subject instanceof Class;
            } else {
                return nativeTypeConstructorMap[subjectType] === Class;
            }
        },
